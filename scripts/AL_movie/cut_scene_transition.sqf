...
// text
_txt_1 = ["Black Transition",3,"center","3","#FFF000"] execVM "AL_movie\txt_display.sqf";
// -------------------------------------
_firstshot = [gigi, gigi, target4, 5, 0.7, 0.7, true, 0, 0, 2,"none","black",3,"snip3",FALSE] execVM "AL_movie\camera_work.sqf";
waitUntil {scriptdone _firstshot};

// text
_txt_3 = ["NO Transition",3,"center","3","#FFF000"] execVM "AL_movie\txt_display.sqf";
// -------------------------------------
_thirdshot = [gigi, gigi, target4, 5, 0.7, 0.7, true, 0, 0, 2,"none","none",0,"snip3",FALSE] execVM "AL_movie\camera_work.sqf";
waitUntil {scriptdone _thirdshot};

// text
_txt_4 = ["Blur Transition",3,"center","3","#FFF000"] execVM "AL_movie\txt_display.sqf";
// -------------------------------------
_4thshot = [gigi, gigi, target4, 5, 0.7, 0.7, true, 0, 0, 2,"none","blur",3,"snip3",FALSE] execVM "AL_movie\camera_work.sqf";
waitUntil {scriptdone _4thshot};


// text
_txt_2 = ["White Transition",3,"center","3","#FFF000"] execVM "AL_movie\txt_display.sqf";
// -------------------------------------
_secondshot = [gigi, gigi, target4, 5, 0.7, 0.7, true, 0, 0, 2,"none","white",3,"none",TRUE] execVM "AL_movie\camera_work.sqf";
